...
/** Powertrain specifications, kept in its own table: it is the densest and most frequently compared block
 *  of attributes, and a plain catalogue listing rarely needs to load it. */
@Entity
