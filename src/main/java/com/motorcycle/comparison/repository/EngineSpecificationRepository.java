...
/**
 * Engine specs are always reached through their {@link com.motorcycle.comparison.entity.Motorcycle}
 * and cascade from it, so this repository exists for analytics-style reads
 * (displacement distributions, power percentiles) rather than for writes.
 */
@Repository
